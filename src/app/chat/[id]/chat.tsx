...
// Placeholder data
const matches = [
  { id: 1, name: "Sarah", avatar: "/placeholder.svg?height=32&width=32", lastMessage: "Hey there!" },
  { id: 2, name: "Mike", avatar: "/placeholder.svg?height=32&width=32", lastMessage: "How's your day going?" },
  { id: 3, name: "Emily", avatar: "/placeholder.svg?height=32&width=32", lastMessage: "Nice to meet you!" },
  { id: 4, name: "Chris", avatar: "/placeholder.svg?height=32&width=32", lastMessage: "What are your hobbies?" },
]

// const initialMessages = [
//   { id: 1, sender: "Sarah", content: "Hey there! How are you?", timestamp: "10:30 AM" },
//   { id: 2, sender: id, content: "Hi Sarah! I'm doing great, thanks for asking. How about you?", timestamp: "10:32 AM" },
//   { id: 3, sender: "Sarah", content: "I'm good too! Just enjoying my day off. Any exciting plans for the weekend?", timestamp: "10:35 AM" },
// ] as {
//   id: string | number;
//   sender:  string;
//   content: string
          ...
          {messages.map((message) => (
            ...
            >
              <div className={`max-w-[70%] p-3 rounded-lg ${
                message.sender === id ? 'bg-primary text-primary-foreground' : 'bg-muted'
              }`}>
                <p>{message.content}</p>
              </div>
